...
from keyboards.keyboards import main_menu_keyboard, album_sections_keyboard
...
async def handle_text(message: Message):
    ...
    elif message.text not in ["📊 Прогресс", "📋 Мой альбом", "➕ Добавить карточки", "🔄 Обмен"]:
        await message.answer("❓ Не распознано. Используйте меню или введите номера карточек.")
